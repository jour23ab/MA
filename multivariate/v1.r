...
model1 = lm(CAR_10_wins ~ Cash + Private + CrossBorder + MtoB + Crisis + Margin + 
            ...
            Diversification + Bull_Bear_Spread + num_prior_mergers + gdp_lag1_tgt, df)
